...
import com.maitaryane.um.service.AdminAccountUpdatePasswordService;
import com.maitaryane.um.validation.AdminAccountUpdatePasswordValidation;
...
@CrossOrigin(origins = "*")
@AllArgsConstructor
public class AdminAccountUpdatePasswordController {
	private final AdminAccountUpdatePasswordService service;
	private final AdminAccountUpdatePasswordValidation validation;
	...
	public ResponseEntity<?> changePassword(Authentication authentication, @RequestBody PasswordRequest password, BindingResult bindingResult) {
		...
		MessageResponse response = new MessageResponse("Admin password updated successfully");
