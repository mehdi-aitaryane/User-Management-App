...
@Service
@AllArgsConstructor
public class AdminAccountUpdatePasswordValidation {
	...
	private BindingResult validateNewPassword(String encodedPassword, String password, BindingResult bindingResult)
	{
		...
		if(passwordEncoder.matches(password, encodedPassword)){
			...
			bindingResult.rejectValue("newPassword", "newPassword", "Password is not changed.");
	...
	private BindingResult validateOldPassword(String encodedPassword, String password, BindingResult bindingResult)
	{
		...
		if(!passwordEncoder.matches(password, encodedPassword)){
			bindingResult.rejectValue("oldPassword", "oldPassword", "Password is not correct.");
		}
